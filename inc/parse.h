/**
* \file
* \brief Заголовочный файл парсера строк
*
* Данный файл содержит описание функций, используемых программой для синтаксического анализирования входных данных.
* Все функции игнорируют пробельные символы.
*/
#ifndef PARSE_H_
#define PARSE_H_
